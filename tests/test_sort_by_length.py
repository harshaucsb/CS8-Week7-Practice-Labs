...
test_params = [
    ["Apple", "Pie", "Computer", "I"],
    [],
    ["Octogon", "Raspberry Smoothie", "Lie", "rAnDoM"],
    ["Cranky"],
    ["A", "BC", "DEF", ""],
    ["Bad idea", 42, "meaning"],
