...
test_params = [
    ({'fruit': 'apple'}, {'fruit': 'banana', 'amount': 5}),
...
function_name = "update_dictionary_values" # TODO

# TODO:  name the class according to the function name being tested
class UpdateDictionaryValue_Test(BaseClass):
    @partial_credit(max_score)
    @visibility('visible')
    def test1(self, set_score=None):
        """update_dictionary_values(orig_dict, new_dict)""" # TODO
